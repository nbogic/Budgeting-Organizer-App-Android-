    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.intro_create:
                //if the create button is pressed at this point in the creation process, it will execute no functions
                System.out.println("There are missing fields!");
                break;
            case R.id.intro_next:
                //gets all the current input from the text boxes
                ...
                //then it is later assigned to the strings initliaised earlier
